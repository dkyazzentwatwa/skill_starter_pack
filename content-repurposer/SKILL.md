...
1. Identify the source thesis, strongest claim, audience, and 2-4 supporting ideas.
2. Distill the source into one clean core message before drafting anything.
3. Generate the full default output pack unless the user asks for a subset.
4. Adapt structure, pacing, and hook style for each platform without changing the underlying argument.
5. End with a short quality check to ensure all outputs are faithful to the source and do not repeat the same wording.
